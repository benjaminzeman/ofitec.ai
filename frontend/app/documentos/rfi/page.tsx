...
export default function DocumentosRfiPage() {
  return (
    <div className="p-6 space-y-6">
      <div className="text-center py-12">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-md mx-auto">
          Sistema digital de Solicitudes de Información (RFI) para proyectos de construcción.
        </p>
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6 max-w-md mx-auto">
          ...
          <p className="text-amber-700 dark:text-amber-300 text-sm">
            Plataforma para gestión de RFIs con seguimiento, aprobaciones digitales
            y integración con sistemas de documentación.
          </p>
        </div>
      </div>
    </div>
