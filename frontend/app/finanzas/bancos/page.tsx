...
export default function FinanzasBancosPage() {
  return (
    <div className="p-6 space-y-6">
      <div className="text-center py-12">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-md mx-auto">
          Integración directa con bancos para sincronización automática de movimientos.
        </p>
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6 max-w-md mx-auto">
          ...
          <p className="text-amber-700 dark:text-amber-300 text-sm">
            Conectores seguros con APIs bancarias para sincronización automática
            de cartolas y movimientos. Integración con Open Banking.
          </p>
        </div>
      </div>
    </div>
