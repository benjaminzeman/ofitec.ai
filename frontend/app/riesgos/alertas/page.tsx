...
export default function RiesgosAlertasPage() {
  return (
    <div className="p-6 space-y-6">
      <div className="text-center py-12">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-md mx-auto">
          Sistema automático de alertas y notificaciones para riesgos críticos y eventos importantes.
        </p>
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6 max-w-md mx-auto">
          ...
          <p className="text-amber-700 dark:text-amber-300 text-sm">
            Sistema de alertas inteligente con notificaciones push, email y SMS.
            Integración con matriz de riesgos y predicciones ML en desarrollo.
          </p>
        </div>
      </div>
    </div>
